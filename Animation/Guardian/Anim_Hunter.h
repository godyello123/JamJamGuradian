...
public:
	UFUNCTION()
		void AnimNotify_Hunter_Attack_Start();
	UFUNCTION()
		void AnimNotify_Hunter_Attack();
	UFUNCTION()
		void AnimNotify_Hunter_Attack_End();
	UFUNCTION()
		void AnimNotify_Hunter_Skill();
	UFUNCTION()
		void AnimNotify_Hunter_Skill_End();
