...
ADefenseGameStateBase::ADefenseGameStateBase()
{

}

void ADefenseGameStateBase::AllSetGem(int32 iCount)
{
...
void ADefenseGameStateBase::AllAddGem(int32 iCount)
{
	m_tGem.iGoldGem += iCount;
	m_pMainUI->SetGoldGemCount(m_tGem.iGoldGem);
...
void ADefenseGameStateBase::AllRemoveGem(int32 iCount)
{
...
void ADefenseGameStateBase::AddGem(int32 iType, int32 iCount)
{
	if (iType < 0 || iType>2)
		return;
...
void ADefenseGameStateBase::RemoveGem(int32 iType, int32 iCount)
{
...
int32 ADefenseGameStateBase::GetGem(int32 iType) const
{
	if (iType == 0)
	{
...
void ADefenseGameStateBase::SetMainUI(UMainUI* pUI)
{
	m_pMainUI = pUI;
}
